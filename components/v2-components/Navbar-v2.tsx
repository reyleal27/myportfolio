    ...
    <div className="w-full h-[65px] fixed top-0 shadow-[#2A0E61]/50 bg-[#03001417] backdrop-blur-md z-50 px-10">
      <div className="w-full h-full m-auto px-[10px] flex items-center justify-between">
        <Link href="/" className="flex flex-row h-auto w-auto items-center">
          ...
          />
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-cyan-400 ml-2 cursor-pointer hover:animate-bounce text-2xl">
            Vincent
          </span>
        </Link>
          ...
          {socials.map((item, index) => {
            ...
            return (
              <Link
                href={item.href}
                key={index}
                className="text-white text-4xl hover:text-purple-600"
                target="_blank"
      ...
      <div
        ...
        } bg-[#000000] p-4 absolute top-[65px] left-0 w-full text-slate-100`}
      >
        <div className="flex flex-col items-center gap-4">
          <Link href="#about" className="cursor-pointer hover:text-purple-400">
            About Me
          </Link>
          <Link href="#skills" className="cursor-pointer hover:text-purple-400">
            Skills
          </Link>
          <Link
            href="#projects"
